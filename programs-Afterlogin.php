...
<html lang="en">
<head>
    <link rel="stylesheet" href="responsive-overrides.css?v=3">
<meta charset="utf-8">
    ...
    <div class="trainer-new-grid reveal-stagger" id="trainerGrid">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.5</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>2000/-</strong>
                ...
                <a href="membership.html" class="hire-btn">Hire Now ❯</a>
            </div>
        </div>
        ...
        <div class="tncard tncard--active">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.9</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>1500/-</strong>
                ...
                <a href="#" class="hire-btn">Hire Now ❯</a>
            </div>
        </div>
        ...
        <div class="tncard">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.0</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>5000/-</strong>
        ...
        <div class="tncard">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.8</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>3500/-</strong>
        ...
        <div class="tncard">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.7</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>3000/-</strong>
        ...
        <div class="tncard">
            ...
            <div class="tncard-body">
                ...
                <div class="tncard-stats">
                    <div class="tncard-stat">
                        <strong class="rating-value"><span class="stat-star">★</span> 4.6</strong>
                        <small>Rating</small>
                    </div>
                    <div class="tncard-stat">
                        <strong>2500/-</strong>
...
<div class="wrapper">
    ...
    <div class="plan-result-box" id="plan-result" style="display:none;">
        ...
        <button onclick="resetForm()" class="action-btn" style="margin-top:25px;">← Generate Another Plan</button>
    </div>

</div><script>
var planDB = {
    loss_ectomorph_beginner:{kcalFormula:function(w){return[Math.round(w*28),Math.round(w*32)]},instructions:["Start with 30 min brisk walks 5 days a week.","Reduce processed sugar and refined carbs completely.","Drink at least 2.5 litres of water daily.","Sleep 7-8 hours — poor sleep raises hunger hormones.","Track your meals in a journal or free app."],foods:["Eggs (boiled or scrambled)","Oats with skim milk","Grilled chicken breast","Green salads with olive oil","Bananas & apples","Brown rice (small portions)","Greek yogurt"],workouts:["30 min walk or light jog (5x/week)","Bodyweight squats: 3×15","Push-ups: 3×10","Plank holds: 3×30 sec","Rest fully on weekends"]},
    ...
    muscle_ectomorph_beginner:{kcalFormula:function(w){return[Math.round(w*36),Math.round(w*42)]},instructions:["Never miss a meal — eat every 3 hours.","Protein goal: 2g per KG bodyweight.","Focus on big compound lifts.","Sleep 8-9 hours.","Avoid excessive cardio."],foods:["Mass gainer shake","Peanut butter","Whole milk","Eggs (6-8/day)","Rice & pasta","Chicken & beef","Oats & bananas"],workouts:["Full body 3x/week","Squat, deadlift, bench, row basics","3-4 sets × 8-12 reps","Rest 2 min between sets","No cardio — walk only"]},
    ...
    muscle_mesomorph_advanced:{kcalFormula:function(w){return[Math.round(w*30),Math.round(w*34)]},instructions:["Periodize annually.","Use RPE to gauge intensity.","Lean bulk — 200-300 kcal surplus.","Recovery: ice baths, massage, 9h sleep.","Work with a coach."],foods:["Lean red meat 2x/week","Salmon 2x/week","Egg variety","Protein isolate","Avocado & olive oil","All complex carb sources","Vegetables at every meal"],workouts:["PPL or bro-split 5-6x/week","18-22 sets/muscle/week","Strength day once a week","Daily 15 min mobility","Quarterly physique assessments"]},
    muscle_endomorph_beginner:{kcalFormula:function(w){return[Math.round(w*26),Math.round(w*30)]},instructions:["Small surplus only.","Lift heavy from day 1.","Keep carbs moderate, protein high.","Walk 30 min daily.","Be patient — endomorphs take longer."],foods:["Chicken breast & eggs","Brown rice (measured)","Broccoli & green vegetables","Almonds","Greek yogurt","Oats","Lean fish"],workouts:["Full body 3x/week — compound only","20 min cardio after lifting","No skipping training days","8,000 steps/day minimum","Sleep 8 hours, no exceptions"]},
...
(function () {
  ...
  /* 1. SCROLL-REVEAL — .reveal fades + slides up on scroll */
  ...
  /* 2. STAGGER CHILDREN — cascade delay on cards inside .reveal-stagger */
  ...
  /* 4. PROGRAM-BOX HOVER LIFT — subtle scale on .program-box */
  ...
  /* 5. GENERATE PLAN BUTTON — ripple effect */
  ...
  /* 6. PLAN RESULT — smooth slide-down reveal when generated */
