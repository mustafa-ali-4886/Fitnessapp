...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['otp'])) {
    ...
    if (!isset($_SESSION['reset_otp']) || !isset($_SESSION['otp_expiry']) || !isset($_SESSION['reset_email'])) {
        $error_message = "Session expired. Please request a new OTP.";
    } elseif (time() > $_SESSION['otp_expiry']) {
        $error_message = "The OTP code has expired. Please try again.";
        ...
        <div class="login-box">
            ...
            <form action="verify_otp.php" method="POST">
                ...
                <div class="register-link">
                    Didn't receive code? 
                    <a href="forgotpassword.html">Resend OTP</a>
                </div>
