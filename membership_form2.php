...
<header class="hero">
    ...
    <div class="booking-left">
        ...
        <form class="membership-form" action="membership_form2.php" method="POST">
            ...
            <div class="input-group">
				...
				<input type="hidden" name="plan" id="selectedPlanInput" value="2">
            </div>
    ...
    <div class="booking-right">
        <div class="selected-plan-card active-plan">
            <h3 class="plan-title">Platinum Package</h3>
            ...
            <ul class="plan-features">
                ...
                <li><i class="fa fa-check"></i> Access to Boxing Area & Sauna</li>
                <li><i class="fa fa-check"></i> Once in a 2 weeks Consultation</li>
                <li><i class="fa fa-check"></i> Get a Personal Trainer</li>
            </ul>
        </div>
    </div>
</div>
