...
<header class="hero">
    ...
    <div class="booking-left">
        ...
        <form class="membership-form" action="membership_form3.php" method="POST">
            ...
            <div class="input-group">
				...
				<input type="hidden" name="plan" id="selectedPlanInput" value="3">
            </div>
    ...
    <div class="booking-right">
        <div class="selected-plan-card active-plan">
            <h3 class="plan-title">Diamond Package</h3>
            <div class="plan-price">Rs 10,000<span>/month</span></div>
            
            <ul class="plan-features">
                <li><i class="fa fa-check"></i> Complete Gym Access</li>
                <li><i class="fa fa-check"></i> Pro Package for Digital Experience</li>
                <li><i class="fa fa-check"></i> 16 Personal Training Sessions</li>
                <li><i class="fa fa-check"></i> Unlimited Consultation</li>
                <li><i class="fa fa-check"></i> Access to Premium Parking</li>
            </ul>
        </div>
    </div>
</div>
